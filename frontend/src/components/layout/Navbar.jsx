  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-[#000000] border-b border-[#1E1E1E]">
      ...
      <div className="border-b border-[#1A1A1A] bg-[#000000]">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 flex items-center justify-between h-[72px] sm:h-[78px]">
          ...
          <div className="flex items-center gap-3">
            ...
            {isSuperAdmin && (
              <button
                ...
                className={`px-3.5 py-2 border text-xs font-mono flex items-center gap-1.5 transition-all cursor-pointer ${
                  activeView === 'settings' 
            ...
            <div 
              onClick={() => setActiveView('settings')}
              className="flex items-center gap-2.5 px-3.5 py-2 bg-[#0A0A0A] border border-[#222222] hover:border-zinc-700 transition-colors cursor-pointer select-none"
            >
              <div className={`relative flex items-center justify-center w-7 h-7 rounded-full border text-xs font-bold font-mono ${
                isSuperAdmin 
            ...
            <button
              ...
              className="p-2.5 border border-[#222222] bg-[#0A0A0A] hover:bg-[#141414] hover:border-zinc-500 text-zinc-400 hover:text-white transition-all cursor-pointer"
            >
            ...
            <button
              ...
              className="px-3 py-2 border border-[#222222] bg-[#0A0A0A] hover:bg-rose-950/40 hover:border-rose-700 text-zinc-400 hover:text-rose-300 transition-all cursor-pointer flex items-center gap-1.5 text-xs font-mono"
            >
            ...
            {navItems.map(item => {
              ...
              return (
                <button
                  ...
                  className={`relative flex items-center gap-2 px-4 py-3 text-xs font-mono tracking-wide transition-all whitespace-nowrap cursor-pointer border ${
                    isActive 
